...
debug=1
unitName="MPP5048MGX"
dataFileP1="MPP5048MGX_1"
dataFileP2="MPP5048MGX_2"
dataFileP3="MPP5048MGX_3"
dataDir="/ramdisk/"
...
while : ; do
        ...
        `/home/pi/mpp-solar -p /dev/hidraw0 -c QPIGS > ${dataDir}${dataFileP1}.$$`
        `mv ${dataDir}${dataFileP1}.$$ ${dataDir}${dataFileP1}.txt`

        # request serial number
        `/home/pi/mpp-solar -p /dev/hidraw0 -c QID > ${dataDir}${dataFileP2}.$$`
        `mv ${dataDir}${dataFileP2}.$$ ${dataDir}${dataFileP2}.txt`

        # request Device Rating Information 
        `/home/pi/mpp-solar -p /dev/hidraw0 -c QPIRI > ${dataDir}${dataFileP3}.$$`
        `mv ${dataDir}${dataFileP3}.$$ ${dataDir}${dataFileP3}.txt`       

        for mppDev in $dataFileP1 $dataFileP2 $dataFileP3
        do
        ...
        `mv ${dataDir}${dataFileP3}.prom.$$ ${dataDir}${dataFileP3}.prom`
